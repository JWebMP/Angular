...
C4Context
    ...
    System_Boundary(plugin, "Angular Plugin") {
        System(system, "JWebMP Angular TS Plugin", "Generates Angular 21 assets and hosts them via Vert.x/STOMP")
    }
    ...
    System_Ext(ngClient, "Angular Client Generated", "Angular 21 SPA built from generated TS")
