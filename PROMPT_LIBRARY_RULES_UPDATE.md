...
- Library name: JWebMP Angular
- Current/new version: 2.0.0-SNAPSHOT
- Repository URL / path: https://github.com/JWebMP/Angular.git
- Rules Repository Location: rules/ (Rules Repository submodule)
- Short description: Uses the typescript JWebMP plugin and generates complete JWebMP Angular applications, as well has hosts a vert.x server to the dist directory
- Type:
...
- Component/topic areas (list): Angular 20 rules, Vert.x 5 + GuicedEE bridges, JWebMP Core/Client/TypeScript integration, Lombok CRTP fluency, Log4j2 logging, testing (Jacoco, Java Micro Harness, BrowserStack)
