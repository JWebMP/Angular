...
import com.jwebmp.core.base.angular.modules.services.rxtxjs.RxJsBehaviourSubjectModule;
...
@NgModuleReference(RxJsBehaviourSubjectModule.class)
...
public class SocketClientService implements INgProvider<SocketClientService> {
    ...
    public List<String> interfaces() {
        return List.of("OnInit", "OnDestroy");
    }
    ...
    public List<String> fields() {
        return List.of("websocket: any;" +
                "dataListenerMappings = new Map<string, BehaviorSubject<any>>();" +
                "");
    }

    @Override
    public List<String> constructorParameters() {
        return List.of("private routeLocation: Location",
    ...
    public List<String> methods() {
        return List.of(" registerListener(listener:string) : any" +
                        "{" +
