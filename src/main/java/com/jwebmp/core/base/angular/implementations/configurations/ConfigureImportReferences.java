...
public class ConfigureImportReferences implements IOnComponentConfigured<ConfigureImportReferences>
{
        ...
        for (IConfiguration configuration : component.getConfigurations())
        {
            ...
            else if (configuration instanceof NgAfterViewChecked ngComponentReference)
            {
                if ((ngComponentReference.onSelf() && !checkForParent) || (ngComponentReference.onParent() && checkForParent))
                {
                    ...
                    compConfig.getAfterViewChecked()
            ...
            else if (configuration instanceof NgAfterContentInit ngComponentReference)
            {
                if ((ngComponentReference.onSelf() && !checkForParent) || (ngComponentReference.onParent() && checkForParent))
                {
                    ...
                    compConfig.getAfterContentInit()
            ...
            else if (configuration instanceof NgAfterContentChecked ngComponentReference)
            {
                if ((ngComponentReference.onSelf() && !checkForParent) || (ngComponentReference.onParent() && checkForParent))
                {
                    ...
                    compConfig.getAfterContentChecked()
    ...
    {
        AnnotationUtils.getAnnotation(component, NgImportModule.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportModules()
    ...
    {
        AnnotationUtils.getAnnotation(component, NgImportProvider.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportProviders()
    ...
    {
        AnnotationUtils.getAnnotation(component, NgSignal.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component, NgInput.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getInputs()
    ...
    {
        AnnotationUtils.getAnnotation(component, NgOutput.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgOnInit.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgOnDestroy.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgAfterViewInit.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgAfterViewChecked.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgAfterContentChecked.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgAfterContentInit.class)
                       .forEach(ngMethod -> {
                           if ((ngMethod.onSelf() && !checkForParent) || (ngMethod.onParent() && checkForParent))
                           {
                               compConfig.getImportReferences()
    ...
    {
        AnnotationUtils.getAnnotation(component.getClass(), NgComponentReference.class)
                       .forEach(importReference -> {
                           if ((importReference.onSelf() && !checkForParent) || (importReference.onParent() && checkForParent))
                           {
    ...
    private List<NgImportReference> retrieveRelativePathForReference(NgComponentReference importReference)
    {
        ...
        {
        }.putRelativeLinkInMap(compConfig.getRootComponent()
